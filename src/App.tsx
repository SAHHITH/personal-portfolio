...
const logos = ["SHAHITH G", "AI ENGINEER", "MLOPS", "DEVELOPER"];
    ...
    <Routes>
      <Route path="/" element={
        <div className="min-h-screen bg-black text-white overflow-x-hidden">
          ...
          <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 md:px-12 py-5 backdrop-blur-xl bg-black/20 border-b border-white/10">
            <div className="flex items-center gap-3">
              ...
              <span className="text-[10px] md:text-xs tracking-[0.3em] text-white/70 uppercase font-medium">
                SHAHITH G · AI ENGINEER & MLOPS DEVELOPER
              </span>
            </div>
          ...
          {mobileMenu && (
            <div className="fixed inset-0 z-40 bg-black/95 backdrop-blur-xl flex flex-col items-center justify-center gap-8 text-white uppercase tracking-[0.3em] text-sm md:hidden">
              ...
              <a
                ...
                onClick={() => setMobileMenu(false)}
                className="px-5 py-2 text-xs border border-white/20 rounded-full hover:bg-white hover:text-black transition-all font-medium tracking-widest mt-2"
              >
                Download Resume
              </a>
            </div>
...
animate-[shine_4s_linear_infinite]">
    ...
    from-white via-white/60 to-white
    animate-[shine_4s_linear_infinite]">
                  Building intelligent AI-powered applications,{" "} <br />
                  <em className="not-italic text-white">
                    scalable full-stack platforms, and modern digital experiences.
                  </em>
                </p>
              </div>
            </div>
